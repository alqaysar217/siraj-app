...
1. تسجيل الدخول: يتم عبر صفحة رابط: https://siraj-app.vercel.app/auth/login.
2. نسيان كلمة السر: لا يوجد زر تلقائي، اطلب من الطالب التواصل مع خدمة العملاء عبر واتساب: +967735952927 ليتم إرسال رابط استعادة يدوي له.
3. تعدد الأجهزة: يسمح بجهازين فقط. إذا ظهر خطأ "تجاوز الحد"، يجب التواصل مع الإدارة لتصفير الأجهزة.
4. إيجاد الدورات: بعد الاشتراك، يجد الطالب دوراته دائماً في "مساحتي التعليمية" عبر رابط: https://siraj-app.vercel.app/dashboard.
5. إخفاء/إظهار الاسم: يمكن للطالب التحكم بظهوره في قائمة المتصدرين من خلال "تعديل الملف الشخصي" في رابط: https://siraj-app.vercel.app/profile.
